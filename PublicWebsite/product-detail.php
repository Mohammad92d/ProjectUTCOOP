...
<?php
	...
	if (!isset($_GET['id'])) {
	 ...
	 $query   = "
		select products.pro_id,products.pro_name,category.cat_id,
        cetegory.cat_name  from products inner join category
        ON products.cat_id=category.cat_id where pro_id = {$_GET['id']}";
...
<?php
	...
	";
	echo"
		<div class='item-slick3' data-thumb='../images/".$row['pro_image']."'>
		<div class='wrap-pic-w pos-relative'>
		 <img alt=IMG-BANNER src=../images/".$row['pro_image'].">
		
		<a class='flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04' 
		href='../images/".$row['pro_image']."'>
