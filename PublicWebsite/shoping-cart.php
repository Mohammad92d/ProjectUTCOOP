...
<img src ='../images/{$row['pro_image']}' width='100' hight='140'/>
</div>
</td>
...
<div name='blus' class='btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m'>
...
<button name="update" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
Update
</button>
</div>
</div>
